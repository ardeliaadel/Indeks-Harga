...
function hitungIndeks(){
 ...
 const indeksTidakTertimbang=((totalPn/totalP0)*100).toFixed(2);
 document.getElementById('indeksOutput').innerHTML=`
 <b>Laspeyres (metode tertimbang)</b><br>
 Rumus: IL: (ΣPn × ΣQ0) / (ΣP0 × ΣQ0) × 100%<br>
 ...
 <b>Paasche (metode tertimbang)</b><br>
 Rumus: IP: (ΣPn × ΣQn) / (ΣP0 × ΣQn) × 100%<br>
 Nilai: (${totalPn} × ${totalQn.toFixed(1)}) / (${totalP0} × ${totalQn.toFixed(1)}) × 100% = ${indeksPaasche}<br>
 Link: <a href="https://youtu.be/gh6rzF_dx4o?si=kEFT7JkekxHCWQb-" target="_blank">https://youtu.be/gh6rzF_dx4o?si=kEFT7JkekxHCWQb-</a><br><br>
 <b>Tidak Tertimbang</b><br>
 Rumus: IP: (ΣPn / ΣP0) × 100<br>
 Nilai: (${totalPn} / ${totalP0}) × 100 = 100.44<br>
 Link: <a href="https://youtu.be/2mRsAwOXxxk?si=RP_IUMajT4RKYH4W" target="_blank">https://youtu.be/2mRsAwOXxxk?si=RP_IUMajT4RKYH4W</a>
 `;
}
</script>
</body>
